...
$targetPath = "C:\Users\97254\.gemini\antigravity\scratch\oz-store\articles_data.js"
[System.IO.File]::WriteAllText($targetPath, $articlesJs, $utf8NoBOM)
Write-Host "articles_data.js generated successfully!"
