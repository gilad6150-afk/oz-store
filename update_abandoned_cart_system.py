...
pages_code_path = r"C:\Users\97254\.gemini\antigravity\scratch\oz-store\pages_code.js"

with open(pages_code_path, "r", encoding="utf-8") as f:
    content = f.read()
...
if "ABANDONED CARTS SECTION" not in content and crm_table_marker in content:
    content = content.replace(crm_table_marker, crm_abandoned_code)

with open(pages_code_path, "w", encoding="utf-8") as f:
    f.write(content)

print("SUCCESS: Updated pages_code.js with Abandoned Cart Recovery System!")
