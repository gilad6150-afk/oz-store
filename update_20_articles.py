...
new_content = re.sub(r"(?s)const articlesDB = \[.*?\];", articles_db, content)

with open(file_path, "w", encoding="utf-8") as f:
    f.write(new_content)

print("Python execution successful: 20 articles injected into products_data.js!")
