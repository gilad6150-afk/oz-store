...
$targetPath = Join-Path $dir "build_merchant_feed_bom.ps1"
[System.IO.File]::WriteAllText($targetPath, $scriptText, $utf8BOM)
Write-Host "Created build_merchant_feed_bom.ps1 with UTF-8 BOM"
