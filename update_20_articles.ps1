...
const articlesDB = [
    {
        ...
        content: `` + $disclaimer + `` + `
            ...
            <div class="flex items-center gap-3">
                <button onclick="openProductPage('1')" class="py-2.5 px-5 bg-oz-primary text-white font-bold text-xs rounded-xl shadow-md">צפה בתפילין מהודרות לבר מצווה ←</button>
    ...
    },
    {
        ...
        content: `` + $disclaimer + `` + `
            ...
            <div class="flex items-center gap-3">
                <button onclick="openProductPage('2')" class="py-2.5 px-5 bg-oz-primary text-white font-bold text-xs rounded-xl shadow-md">לרכישת מזוזות כשרות ←</button>
                <button onclick="openAccountPageWithWishlist()" class="py-2.5 px-5 bg-purple-50 text-oz-primary font-bold text-xs rounded-xl border border-purple-200">שמור במועדפים VIP ❤️</button>
            </div>
        `
    },
    {
        ...
        content: `` + $disclaimer + `` + `
            ...
            <button onclick="openProductPage('3')" class="py-2.5 px-5 bg-oz-primary text-white font-bold text-xs rounded-xl shadow-md">לרכישת טלית צמר טהור ←</button>
        `
    },
    {
        id: 4,
        title: "כתיבת ספר תורה מהודר: תהליך היצירה, סוגי הקלף, הדיור והגהות הסופר",
        category: "ספרי תורה",
        ...
        content: `` + $disclaimer + `` + `
            <h3 class="font-black text-xl text-slate-900 mb-3">המצוות התרי\"ג: כתיבת ספר תורה אישי</h3>
            ...
            <ol class="list-decimal list-inside space-y-2 text-xs text-slate-700 mb-4">
                ...
                <li><strong>שרטוט הירעות:</strong> שרטוט בסרגל ועץ כדי ששורות הכתב יצאו ישרות ומדויקות.</li>
    ...
    },
    {
        ...
        content: `` + $disclaimer + `` + `
            ...
            <button onclick="openProductPage('1')" class="py-2.5 px-5 bg-oz-primary text-white font-bold text-xs rounded-xl shadow-md">לצפייה בסט תפילין לבר מצווה ←</button>
        `
    },
    {
        id: 9,
    ...
    },
    {
        ...
        content: `` + $disclaimer + `` + `
            <h3 class="font-black text-xl text-slate-900 mb-3">מחלקת רש\"י ורבינו תם בסדר הפרשיות</h3>
    ...
    },
    {
        ...
        content: `` + $disclaimer + `` + `
            ...
            <p class="text-xs text-slate-600 leading-relaxed mb-4">שופר כשר חייב להיות עשוי מקרן איל (זכר לריעקת יצחק) ללא נקבים או סדקים לאורכו. במכון עוז כל השופרות נבדקים ונבחנים בקפידה.</p>
        `
    },
    {
        id: 20,
...
$newContent = [regex]::Replace($content, '(?s)const articlesDB = \[.*?\];', $articlesJs)

[System.IO.File]::WriteAllText($filePath, $newContent, $utf8NoBOM)
Write-Host "20 SEO articles with halachic disclaimer and internal links injected successfully!"
