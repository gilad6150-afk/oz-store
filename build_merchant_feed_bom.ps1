...
[void]$sb.AppendLine('    <title>׳׳›׳•׳ ׳¢׳•׳– - Google Merchant Center Product Feed</title>')
[void]$sb.AppendLine('    <link>https://oz-judaica.co.il</link>')
[void]$sb.AppendLine('    <description>׳₪׳™׳“ ׳׳•׳¦׳¨׳™׳ ׳¨׳©׳׳™ ׳¢׳‘׳•׳¨ Google Shopping ׳•׳”׳•׳₪׳¢׳” ׳‘׳׳ ׳•׳¢ ׳”׳—׳™׳₪׳•׳© ׳©׳ ׳’׳•׳’׳</description>')
...
foreach ($p in $products) {
    ...
    [void]$sb.AppendLine('      <g:brand>׳׳›׳•׳ ׳¢׳•׳–</g:brand>')
...
[System.IO.File]::WriteAllText($feedPath, $sb.ToString(), $utf8NoBOM)
Write-Host "ג… Google Merchant XML Feed generated successfully at google_merchant_feed.xml!"