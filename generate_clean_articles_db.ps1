...
for ($i = 0; $i -lt 45; $i++) {
    ...
    elseif ($title -like "*חג*" -or $title -like "*מינים*") { $cat = "חגים ומועדים" }
    elseif ($title -like "*מתנו*" -or $title -like "*גביע*" -or $title -like "*שבת*") { $cat = "יודאיקה ומתנות" }
    ...
    $summary = "מדריך מקצועי ומורחב מבית מכון עוז בראש העין בנושא $title. כל הטיפים, המידע ההלכתי וההנחיות המעשיות לקנייה נבונה."
